...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {p1, v2, p4, v1, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILokio/BufferedSource;I)V
    ...
    .end local p0    # "this":Lokhttp3/internal/http2/Http2Reader;
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v2, v7, v8}, Lokio/BufferedSource;->readByteString(J)Lokio/ByteString;

    move-result-object v0

    .line 330
    :cond_0
    invoke-interface {p1, v1, v6, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lokio/ByteString;)V
    ...
    .end local v5    # "opaqueDataLength":I
    .end local v6    # "errorCode":Lokhttp3/internal/http2/ErrorCode;
    .end local p0    # "this":Lokhttp3/internal/http2/Http2Reader;
    .end local p1    # "handler":Lokhttp3/internal/http2/Http2Reader$Handler;
    .end local p2    # "length":I
    .end local p3    # "flags":B
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .local v1, "ack":Z
    :cond_0
    invoke-interface {p1, v1, v0, v3}, Lokhttp3/internal/http2/Http2Reader$Handler;->ping(ZII)V
...
.method private readRstStream(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 239
    .local v4, "errorCode":Lokhttp3/internal/http2/ErrorCode;
    if-eqz v4, :cond_0

    .line 242
    invoke-interface {p1, p4, v4}, Lokhttp3/internal/http2/Http2Reader$Handler;->rstStream(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    .end local v4    # "errorCode":Lokhttp3/internal/http2/ErrorCode;
    .end local p0    # "this":Lokhttp3/internal/http2/Http2Reader;
    .end local p1    # "handler":Lokhttp3/internal/http2/Http2Reader$Handler;
    .end local p2    # "length":I
    .end local p3    # "flags":B
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 279
    .end local v2    # "settings":Lokhttp3/internal/http2/Settings;
    .end local v4    # "i":I
    .end local v5    # "id":S
    ...
    .line 272
    .restart local v2    # "settings":Lokhttp3/internal/http2/Settings;
    ...
    :cond_5
    :goto_1
    invoke-virtual {v2, v5, v6}, Lokhttp3/internal/http2/Settings;->set(II)Lokhttp3/internal/http2/Settings;
    ...
    .end local v4    # "i":I
    :cond_6
    invoke-interface {p1, v1, v2}, Lokhttp3/internal/http2/Http2Reader$Handler;->settings(ZLokhttp3/internal/http2/Settings;)V
...
.method private readWindowUpdate(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 338
    invoke-interface {p1, p4, v3, v4}, Lokhttp3/internal/http2/Http2Reader$Handler;->windowUpdate(IJ)V
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    .end local p2    # "handler":Lokhttp3/internal/http2/Http2Reader$Handler;
    :cond_0
    new-array p1, v3, [Ljava/lang/Object;
    ...
    .restart local p2    # "handler":Lokhttp3/internal/http2/Http2Reader$Handler;
    :cond_1
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/BufferedSource;
    ...
    invoke-static {v3, v2, v1, v4, v0}, Lokhttp3/internal/http2/Http2;->frameLog(ZIIBB)Ljava/lang/String;
    ...
    .line 157
    :pswitch_0
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readWindowUpdate(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 153
    :pswitch_1
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 149
    :pswitch_2
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 145
    :pswitch_3
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 141
    :pswitch_4
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 137
    :pswitch_5
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readRstStream(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 133
    :pswitch_6
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 129
    :pswitch_7
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readHeaders(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 125
    :pswitch_8
    invoke-direct {p0, p2, v1, v0, v2}, Lokhttp3/internal/http2/Http2Reader;->readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-static {v5, v6}, Lokhttp3/internal/Util;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v0}, Lokio/ByteString;->equals(Ljava/lang/Object;)Z
